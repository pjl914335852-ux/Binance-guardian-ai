...
**核心组件：**
- **Telegram 接口** - 用户友好的聊天界面
- **AI 守护者代理** - OpenClaw + Claude/Gemini 双模型路由
- **风险检测** - 4 维度评分引擎 + 骗局数据库
- **AI 分析** - 自然语言处理 + 人话翻译
- **币安 API** - 实时市场数据（只读权限）
- **安全警报** - 24/7 监控 + 即时通知
...
> "投入 1 BNB 的初衷，不是为了在波动中博取百倍收益，而是为了建立一个哪怕在极端行情下也能保持冷静、守护家人的自动化哨兵。"

### 转变

**2024 年初：** 这个项目最初源于一个简单的想法——帮助普通人更安全地参与加密货币投资。创始人并非专业开发者，而是一个关心家人资产安全的普通投资者。最初只是收集一些公开的诈骗币名单，手动查询币安 API，帮助身边的人避坑。

**2024 年中：** 随着身边越来越多朋友和家人开始询问加密货币问题——"Pi 币能买吗？""这个新币靠谱吗？"——创始人意识到，比起追求收益，更重要的是帮助普通人避开陷阱。于是开始尝试用 Telegram Bot 把这些查询自动化，让更多人能方便地获取安全信息。

**2025 年：** 项目定位逐渐清晰：与其追求利润最大化，不如追求风险最小化。通过整合币安 API、公开的诈骗数据库、简单的术语解释等资源，项目从手动查询演变成半自动化的"信息助手"。重点功能包括币种安全检查、术语解释、基础安全提示。

**2026 年初：** OpenClaw 平台的出现让一切变得简单。创始人发现可以用 OpenClaw 的 AI 框架快速整合之前积累的功能，并添加更智能的交互。Binance Guardian AI 正式成型——这不是一个复杂的交易系统，而是一个真正为普通人设计的加密货币守护者。它整合了多个公开资源和 API，让非技术背景的人也能安全地参与加密货币投资。
...
本项目主要基于以下技术和公开资源：
- **OpenClaw** (2026) - AI 助手框架，让整合变得简单
- **Binance API** - 市场数据和账户查询（只读权限）
- **Telegram Bot API** - 用户交互界面
- **Chart.js** - 数据可视化
- **公开诈骗数据库** - 风险识别

创始人的角色更像是"整合者"和"产品设计者"，而非传统意义上的"开发者"。2024-2025 年主要是手动收集信息和简单的脚本，2026 年有了 OpenClaw 才真正实现了智能化和自动化。项目的核心价值在于将现有技术整合成一个对普通人友好的安全工具。
